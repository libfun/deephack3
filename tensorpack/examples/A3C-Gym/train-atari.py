...
def get_config():
    ...
    return TrainConfig(
        ...
        callbacks=[
            ModelSaver(),
            ScheduledHyperParamSetter('learning_rate', [(480, 0.0003), (720, 0.0001)]),
            ScheduledHyperParamSetter('entropy_beta', [(480, 0.005)]),
            ScheduledHyperParamSetter('explore_factor',
                                      [(480, 2), (600, 3), (720, 4), (840, 5)]),
            master,
